define(['directives/directives'],function(directives){
        directives.directive('checkboxGoulouciyaotizheng',[function(){
	        return {
	            restrict:"EA",
                scope :{
                    ngModel:"=",
	            ...
	            replace:true,
                link : function(scope){
                    scope.datas = [{id:"HR621_1",text:"无"},
                                   {id:"HR621_2",text:"枕秃"},
                                   {id:"HR621_3",text:"囟门增大"},
                                   {id:"HR621_4",text:"囟门晚闭"},
                                   {id:"HR621_5",text:"出牙迟缓"},
                                   {id:"HR621_6",text:"肋外翻"},
                                   {id:"HR621_7",text:"肌肉韧带松弛"}];
                        ...
                        if(checkbox.checked){
                            ...
                            if(scope.ngModel){
                                if(code=="HR621_1;"){
                                    ...
                                    if(scope.ngModel.indexOf("HR621_1")>=0){
