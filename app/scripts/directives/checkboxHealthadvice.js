define(['directives/directives'],function(directives){
        directives.directive('checkboxHealthadvice',[function(){
	        return {
	            restrict:"EA",
                scope :{
                    ngModel:"=",
	            ...
	            replace:true,
                link : function(scope){
                    scope.datas = [{id:"arch_jkzd_1",text:"定期随访"},{id:"arch_jkzd_2",text:"纳入慢性病患者健康管理"},{id:"arch_jkzd_3",text:"建议复查"},{id:"arch_jkzd_4",text:"建议转诊"}];
