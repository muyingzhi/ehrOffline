define(['directives/directives'],function(directives){
        directives.directive('checkboxLd',[function(){
	        return {
	            restrict:"EA",
                scope :{
                    ngModel:"=",
                ...
                link : function(scope){
                    scope.datas = [
                        {id:"lady_jwbs_1",text:"无"},
                        {id:"lady_jwbs_2",text:"心脏病"},
                        {id:"lady_jwbs_3",text:"肾脏疾病"},
                        {id:"lady_jwbs_4",text:"肝脏疾病"},
                        {id:"lady_jwbs_5",text:"高血压"},
                        {id:"lady_jwbs_6",text:"贫血"},
                        {id:"lady_jwbs_7",text:"糖尿病"},
                        {id:"lady_jwbs_8",text:"其他"}];
                        ...
                        if(checkbox.checked){
                            ...
                            if(scope.ngModel){
                                if(code=="lady_jwbs_1;"){
                                    ...
                                    if(scope.ngModel.indexOf("lady_jwbs_1")>=0){
