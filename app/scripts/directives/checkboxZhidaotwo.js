define(['directives/directives'],function(directives){
        directives.directive('checkboxZhidaotwo',[function(){
	        return {
	            restrict:"EA",
                scope :{
                    ngModel:"=",
	            ...
	            replace:true,
                link : function(scope){
                    scope.datas = [{id:"HR556_1",text:"喂养指导"},
                                   {id:"HR556_2",text:"发育指导"},
                                   {id:"HR556_3",text:"防病指导"},
                                   {id:"HR556_4",text:"预防伤害指导"},
                                   {id:"HR556_5",text:"口腔保健指导"}];
