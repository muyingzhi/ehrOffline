define(['directives/directives'],function(directives){
        directives.directive('checkboxArchivesMeans',[function(){
	        return {
	            restrict:"EA",
                scope :{
                    ngModel:"=",
	            ...
	            replace:true,
                link : function(scope){
                    scope.datas = [{id:"jkjy_cdzl_1",text:"书面材料"},
                                   {id:"jkjy_cdzl_2",text:"图片材料"},
                                   {id:"jkjy_cdzl_3",text:"印刷材料"},
                                   {id:"jkjy_cdzl_4",text:"影音材料"},
                                   {id:"jkjy_cdzl_5",text:"居民签到表"},
                                   {id:"jkjy_cdzl_6",text:"其他材料"}];
