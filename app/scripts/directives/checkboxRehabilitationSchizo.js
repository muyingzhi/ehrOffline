define(['directives/directives'],function(directives){
        directives.directive('checkboxRehabilitationSchizo',[function(){
	        return {
	            restrict:"EA",
                scope :{
                    ngModel:"=",
	            ...
	            replace:true,
                link : function(scope){
                    scope.datas = [{id:"HR488_2",text:"生活劳动能力"},{id:"HR488_3",text:"职业训练"},{id:"HR488_4",text:"学习能力"},{id:"HR488_5",text:"社会交往"},{id:"HR488_6",text:"其他"}];
