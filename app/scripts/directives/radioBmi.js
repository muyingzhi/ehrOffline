define(['directives/directives'],function(directives){
        directives.directive('radioBmi',[function(){
	        return {
	            restrict:"EA",
                scope :{
                    ngModel:"=",
	            ...
	            replace:true,
                link : function(scope){
                    scope.datas = [{id:"1",text:"(BMI＜24)"},{id:"2",text:"(24≤BMI＜25)"},{id:"3",text:"(25≤BMI＜26)"},{id:"4",text:"(26≤BMI＜28)"},{id:"5",text:"(BMI≥28)"}];
                    scope.click = function(code){
                       ...
                       // document.getElementById(item).value=selectitem;
