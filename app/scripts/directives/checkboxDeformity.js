define(['directives/directives'],function(directives){
        directives.directive('checkboxDeformity',[function(){
	        return {
	            restrict:"EA",
                scope :{
                    ngModel:"=",
                ...
                link : function(scope){
                    scope.datas = [
                        {id:"HR402_1",text:"无残疾"},
                        {id:"HR402_2",text:"视力残疾"},
                        {id:"HR402_3",text:"听力残疾"},
                        {id:"HR402_4",text:"言语残疾"},
                        {id:"HR402_5",text:"肢体残疾"},
                        {id:"HR402_6",text:"智力残疾"},
                        {id:"HR402_7",text:"精神残疾"},
                        {id:"HR402_8",text:"其它残疾"}];
                        ...
                        if(checkbox.checked){
                            ...
                            if(scope.ngModel){
                                if(code=="HR402_1;"){
                                    ...
                                    if(scope.ngModel.indexOf("HR402_1")>=0){
