define(['directives/directives'],function(directives){
        directives.directive('checkboxZhidao',[function(){
	        return {
	            restrict:"EA",
                scope :{
                    ngModel:"=",
	            ...
	            replace:true,
                link : function(scope){
                    scope.datas = [{id:"kid_db_guidance_1",text:"科学喂养"},
                                   {id:"kid_db_guidance_2",text:"生长发育"},
                                   {id:"kid_db_guidance_3",text:"预防意外伤害"},
                                   {id:"kid_db_guidance_4",text:"疾病预防"},
                                   {id:"kid_db_guidance_5",text:"口腔保健"}];
