...
define(['controller/controllers',
	    ...
	    app.controller("ladyFirstcheckDetailController",['$rootScope','$scope','$routeParams','$indexedDB','dataDicts','DataDictService'
	        ,function($rootScope,$scope,$routeParams,$indexedDB,dataDicts,datadictService){
		        ...
		        //---------设置顶端菜单
		        $rootScope.topNav = [{text:"返回",iconClass:"glyphicon-circle-arrow-left",url:"#/arch/visitslist/"+aid}];
		        //---------用于存放参数信息
		        $scope.lady={};
		        //---------字典加载
